...
<!DOCTYPE HTML>
		...
		<form action="valida_rel_pagina_destino.php" method="post">
		...
		<div class="row">
			...
			<div class="col-md-6"><hr>
				...
				<button class="btn btn-success" type="submit" style="width: 150px;"> Acessar </button>&nbsp;&nbsp;&nbsp;
